    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span>
            Frontend Developer with high level of experience in Web Designing & Development, Data Structures and Algorithms(C++), Database Management Systems, and Operating Systems.
          </span>
        </div>
